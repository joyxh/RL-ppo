...
# if rank == 0:
DEFAULT_LOG_DIR = os.path.join('experiments', 'ppo1')
...
def main():
    ...
    # CarRacing-v0,Reacher2BenchmarkEnv-v1,DemonAttackNoFrameskip-v4
    parser.add_argument('--env-id', help='environment id', default='Reacher2BenchmarkEnv-v1')
