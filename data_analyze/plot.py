...
import sys
sys.path.append('/root/projects/robot_learning/rllib/')
from envs.reacher_benchmark_env.reacher_benchmark import given_obj_pos, clip_j, NewRewF

clip_obs = clip_j
NewRewF = NewRewF
sys.path.append('/root/projects/robot_learning/')
file_dir = './experiments/trpo_new3/Reacher2BenchmarkEnv-v1/20181216-2209/'
